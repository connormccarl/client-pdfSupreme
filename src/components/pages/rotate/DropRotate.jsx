...
const DropRotate = () => {
  ...
  const handleRotate = async () => {
    ...
    // modify rotateby to factor of 90, 180, 270
    const quotient = rotateby / 90;
    ...
    // Calling /rotate-pdf
    console.log("Calling /rotate-pdf");

    const apiURL = "https://pdfapi-zdtz.onrender.com";

    // assign form data
    const form = new FormData();
    form.append("rotateby", rotateby.toString());
    form.append("file", uploadedFile);

    // make api call
    const finishedURL = await fetch(apiURL + "/rotate-pdf", {
      method: "POST",
      body: form,
    })
      .then((response) => {
