          ...
          <div className="row no-gutters slider-text align-items-center justify-content-center">
            <div className="col-md-9 pt-5 text-center">
              <div className="d-flex align-items-center justify-content-center">
                ...
                <h2 className="mb-0 bread protect-h">
                  Pages Deleted Successfuly
                </h2>
              </div>
      ...
      <section className="download-box">
          ...
          <div className="d-flex justify-contents-center align-items-center">
            <Link to="/delete">
              <button
                ...
                data-bs-title="Back to Delete PDF"
              >
        ...
        <div className="inner-box d-block ms-2">
          <button
            ...
            data-bs-title="View Deleted PDF"
          >
          ...
          <Link to="/delete">
            <button
              type="button"
              class="btn back-icon btn-sm me-3 mt-2"
              data-bs-toggle="tooltip"
